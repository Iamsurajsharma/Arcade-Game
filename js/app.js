    ...
    */
    Player.prototype.handleInput = function(key) {
        ...
        if (lock) return;
        if (key == 'left') {
            this.x = (this.x - this.speed + 450) % 450;
        } else if (key == 'right') {
    ...
    */
    ...
    var scoureCounter= document.createElement('h2');
    function toggleModal() {
        modal.classList.toggle("show-modal");
        scoureCounter.innerHTML= `<h2>Your Score is ${score}</h2>`;
        displayScore.appendChild(scoureCounter);
